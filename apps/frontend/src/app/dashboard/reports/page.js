  ...
  useEffect(() => {
    const fetchAllReports = async () => {
      try {
        ...
        // Fetch all potholes (no limit)
        const res = await fetch(`${backendUrl}/potholes?sort=createdAt:desc`);
              ...
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-space-sm">
                <div>
                  ...
                  <p className="font-body-sm text-body-sm text-on-surface-variant">
                    Track repairs and verification progress on all issues you reported
                  </p>
                </div>
                <Link
                  href="/dashboard"
