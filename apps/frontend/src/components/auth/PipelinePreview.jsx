...
const PotholePreview = () => (
  <div className="mt-space-sm rounded-lg overflow-hidden relative h-28 bg-surface-variant flex items-center justify-center">
    <img
      ...
      alt="Road surface with a pothole detection overlay"
    ...
    <div className="absolute inset-0 bg-inverse-surface/30 backdrop-blur-[1px] flex items-center justify-center">
      <div className="px-3 py-1.5 rounded-lg bg-surface/90 shadow-md backdrop-blur-md flex items-center gap-2">
        ...
        <span className="font-label-sm text-label-sm text-on-surface font-semibold">Severe Crack • Depth: 4.8cm</span>
      </div>
    </div>
  </div>
);
  ...
  return (
    <div className="lg:col-span-5 flex flex-col justify-between space-y-space-lg">
      <div className="flex flex-col space-y-space-md">
        ...
        <section className="mt-space-md bg-surface-container-lowest rounded-xl p-space-md shadow-md flex flex-col space-y-space-md relative overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-title-md text-title-md text-on-surface font-bold">Rapid Ingestion Pipeline</span>
            </div>
          ...
          <div className="grid grid-cols-1 gap-space-sm pt-space-xs">
            <div className="flex items-start gap-space-sm p-space-sm rounded-lg bg-surface-container-low transition-transform hover:translate-x-1 duration-200">
              ...
              <div className="flex flex-col">
                <span className="font-title-md text-title-md text-on-surface text-[14px] leading-tight">1. Instant Camera &amp; Dashcam Capture</span>
                <span className="font-body-sm text-body-sm text-on-surface-variant text-[12px]">Zero latency frame extraction under direct sunlight or rain.</span>
              </div>
            </div>
            ...
            <div className="flex flex-col p-space-sm rounded-lg bg-surface-container transition-all">
              <div className="flex items-start gap-space-sm">
                ...
                <div className="flex flex-col flex-1">
                  <div className="flex items-center justify-between">
                    <span className="font-title-md text-title-md text-on-surface text-[14px] leading-tight">2. Neural CV Segmentation</span>
                    <span className="font-label-sm text-label-sm text-tertiary font-bold">98.4% Confidence</span>
                  </div>
                  <span className="font-body-sm text-body-sm text-on-surface-variant text-[12px]">Dynamic depth estimation &amp; volumetric asphalt analysis.</span>
                </div>
              </div>
              <PotholePreview />
            </div>
            ...
            <div className="flex items-start gap-space-sm p-space-sm rounded-lg bg-surface-container-low transition-transform hover:translate-x-1 duration-200">
              ...
              <div className="flex flex-col">
                <span className="font-title-md text-title-md text-on-surface text-[14px] leading-tight">3. DPW &amp; City Council Dispatch</span>
                <span className="font-body-sm text-body-sm text-on-surface-variant text-[12px]">Auto-routed GPS coordinates directly into work-order queues.</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="mt-space-xs p-space-sm bg-surface-container-lowest rounded-xl shadow-sm flex items-center gap-space-sm">
          <div className="w-14 h-14 rounded-lg overflow-hidden shrink-0 shadow-inner">
            <div
              ...
              style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAvz1Y3GZnZ1SsJeiiSPHOdH4jGPRz7Gn3-m3FWZ3hqj1dwWs27icS34pI-ZUnVFRaFzUIjIRExg9H6r9vEIQ2w_q-vWj39tn8a9Y_3jaFmk4gmLFNzyfzBYSirvQrBbAmwlG5_8bGyTz65Lcxq-RVqqSg6Trth-CH1sEW9tkceGNXUL_boAsqL_9S-rTMwx82rLXeBHpYIR6sk8HiX5iWlHipBh8IDEFf0-9BYQAGFQTyoFJ5BEkk9Eg')" }}
            />
          </div>
          <div className="flex flex-col min-w-0 flex-1">
            <div className="flex items-center gap-1.5">
              <span className="material-symbols-outlined text-primary text-[16px]">location_on</span>
              <span className="font-title-md text-title-md text-on-surface text-[13px] truncate">14th St &amp; Broadway Ave</span>
            </div>
            <span className="font-body-sm text-body-sm text-on-surface-variant text-[11px] truncate">Priority Queue: High (48h Resolution Target)</span>
          </div>
      ...
      <div className="flex items-center gap-2 text-on-surface-variant pt-space-xs">
        ...
        <span className="font-body-sm text-body-sm font-medium">AI-powered road reporting for safer communities.</span>
      </div>
    </div>
  );
}
